        ...
        <div className=''>
            ...
            <table className='min-w-full bg-white border border-gray-200/40'>
                <thead>
                    <tr className="bg-gray-100/40 text-[#998E8D] font-semibold text-xs">
                        ...
                        <th className="py-4 px-4 text-left border-b">Image</th>
                        <th className="py-4 px-4 text-left border-b">Content Name</th>
                        ...
                        <th className="py-4 px-4 text-left border-b">Time</th>
                    </tr>
                </thead>
                <tbody className=''>
                    <tr className='hover:bg-gray-50 text-[#333333] font-normal text-xs'>
                        <td className='py-5 px-4 border-b'>1</td>
                        <td className='py-5 px-4 border-b text-[#5420A4]'>
                            <Image src={image} alt='' className='rounded-lg object-cover h-8 w-8'/>
                        </td>
                        <td className='py-5 px-4 border-b font-bold'>Michael foster</td>
                        <td className='py-5 px-4 border-b text-[#9B9FA5]'>2d89f0c8</td>
                        <td className='py-5 px-4 border-b'>Painting</td>
                        <td className='py-5 px-4 border-b'>22,300</td>
                        <td className='py-5 px-4 border-b'>24, Dec 2024</td>
                        <td className='py-5 px-4 border-b'>10:00PM</td>
                    </tr>
                </tbody>
            </table>
            ...
            { downloadTransaction && (
                <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-[99] '>
                    <div className='bg-white rounded-lg shadow-lg w-1/3 h-[] p-6 relative overflow-y-auto no-scrollbar'>
